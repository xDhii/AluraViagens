...
//        precoSemDescontoLabel.text = "R$ \(viagem?.precoSemDesconto ?? 0)"
        ...
        atributoString.addAttribute(.strikethroughStyle, value: 1, range: NSMakeRange(0, atributoString.length) )
